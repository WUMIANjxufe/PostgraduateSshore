    ...
    wx.showModal({
      ...
      success(res) {
        if (res.confirm) {
          ...
          let { classId, sId, sName, sPhone, sSex, sIntention, sSchool, sMajor } = e.detail.value;
          if (!classId || !sId || !sName || !sPhone || !sSex || !sIntention || !sSchool
            || !sMajor) {
            wx.showToast({
              title: '信息未填写完整！',
              icon: "none"
          ...
          var that = this;
          wx.request({
            url: 'http://127.0.0.1:8000/api/mgr/Sudent_intention',
            method: 'POST',
            data: {
              action: 'add_Sudent_intention',
              data: {
                ...
                sIntention: e.detail.value["sIntention"],
